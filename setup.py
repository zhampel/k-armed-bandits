...
NAME = 'karmband'
DESCRIPTION = 'Demo of k-Armed Bandit Type Problems',
MAINTAINER = 'Zigfried Hampel-Arias'
MAINTAINER_EMAIL = 'zhampel.github@gmail.com'
URL = 'https://github.com/zhampel/k-armed-bandits'
LICENSE = 'MIT'
...
about = {}
with io.open(os.path.join(here, 'karmband', '__version__.py'), encoding='utf-8') as f:
    exec(f.read(), about)
